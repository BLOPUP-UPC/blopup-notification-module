...
public class DWRModuleMessageService {
	...
	/**
	 * The max amount of time (in milliseconds) that 2 messages can be apart before they are grouped
	 * separately. Currently it is 1 hour.
	 */
	...
	public String sendMessage(String content, String toAddressString, String fromAddressString, Integer recipientId,
	        Integer senderId, String protocolId, boolean isFromCurrentUser) {
