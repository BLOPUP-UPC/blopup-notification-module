...
/**
 * MessageBean is a class for sending message objects over ajax. It's very similar to a Message,
 * except all data is in text form and there is an additional 'colornumber' that specifies what
 * color the sender's name should be.
 * 
...
public class MessageBean implements Serializable {
	...
	public MessageBean(Message message) {
		...
		this.setProtocolName(Context.getService(MessagingService.class).getProtocolById(message.getProtocolId())
		        .getProtocolName());
