...
public class AddAddressController {
	...
	public String addAddress(@RequestParam(value = "person", required = false) Person person,
	        @RequestParam("address_type") String addressType, @RequestParam("address") String address,
