...
/**
 * This tag prints out the to or from string for a message accepts: message or messageId prints out:
 * Sender/Recipient if not null, Origin/Destination otherwise
 */
