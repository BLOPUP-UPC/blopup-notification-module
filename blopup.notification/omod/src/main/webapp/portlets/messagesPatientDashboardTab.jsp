...
<div class="conversationBox">
	<div class="boxHeader">
		...
		<img id="refreshButton" class="align-right" src="<openmrs:contextPath/>/moduleResources/blopup.notification/images/refresh.png" onclick="fillMessageList()"/>
	</div>
	<div class="box">
...
<script type="text/javascript">
	...
	function fillMessageList() {
		$("refreshButton").src = "../openmrs/moduleResources/blopup.notification/images/ajax-loader.gif";
		...
		$("refreshButton").src = "<openmrs:contextPath/>/moduleResources/blopup.notification/images/refresh.png";
		});
	}
