<%@ include file="/WEB-INF/view/module/blopup.notification/include.jsp"%>

<openmrs:require privilege="Manage Blopup Notification Gateways" otherwise="/login.htm" redirect="/module/messaging/manageGateways.form"/>
...
<div id="modemsBoxHeader" class="boxHeader"> 
	<img id="modemsStatusImg" src="<openmrs:contextPath/>/moduleResources/blopup.notification/images/bullet_red.png" style="vertical-align:bottom;"/>
	Phones and Modems
</div>
...
<div id="googleVoiceBoxHeader" class="boxHeader"> 
	<img id="googleVoiceStatusImg" src="<openmrs:contextPath/>/moduleResources/blopup.notification/images/bullet_red.png" style="vertical-align:bottom;"/>
	Google Voice
</div>
<div id="googleVoiceBox" class="box">
	Google Voice username: ${googleVoiceUsername}<br/><br/>
	Change the Google Voice login:
	<form method="post" action="<openmrs:contextPath/>/module/blopup.notification/changeGoogleVoiceCreds.form">
...
<b id="emailBoxHeader" class="boxHeader">
	<img id="emailStatusImg" src="<openmrs:contextPath/>/moduleResources/blopup.notification/images/bullet_red.png" style="vertical-align:bottom;"/>
	Email
</b>
<div id="emailBox" class="box">
	Configure Email accounts:
	<form method="post" action="<openmrs:contextPath/>/module/blopup.notification/changeEmailCreds.form">
...
<script type="text/javascript">
	...
	var classPrefix = "org.openmrs.module.blopup.notification.";
	...
	function updateStatus(gatewayId,prefix,callback){
		...
		DWRGatewayStatusService.isGatewayActive(classPrefix + gatewayId, function(isActive){
			...
			if(!isActive){
				...
				$(prefix+"StatusImg").src="<openmrs:contextPath/>/moduleResources/blopup.notification/images/bullet_red.png";
				callback(false);
			}else{
				$(prefix+"StartStopButton").innerHTML="Stop Gateway";
				$(prefix+"StatusImg").src="<openmrs:contextPath/>/moduleResources/blopup.notification/images/bullet_green.png";
				callback(true);
			}
		});
	}
	...
	function stopGateway(gatewayId, prefix, callback){
		...
		$(prefix +"StatusImg").src="<openmrs:contextPath/>/moduleResources/blopup.notification/images/ajax-loader.gif";
