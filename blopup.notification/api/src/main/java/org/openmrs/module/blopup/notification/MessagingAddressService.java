...
public interface MessagingAddressService extends OpenmrsService {
	...
	/**
	 * @param addressId the addressId of the MessagingAddress that you want
	 * @return the MessagingAddress with an addressId that matches the parameter you supplied
	 */
	@Transactional(readOnly = true)
	...
	/**
	 * This method performs a like query on MessagingAddress.address with wildcards before and after
	 * the search string
	 * 
	...
	/**
	 * Un-retires a MessagingAddress, leaving retiredBy, dateRetired, and retireReason set as
	 * markers of the last time the object was retired
	 * 
	 * @param address
	 */
	@Transactional
