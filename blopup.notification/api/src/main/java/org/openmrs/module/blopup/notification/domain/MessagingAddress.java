package org.openmrs.module.blopup.notification.domain;
...
/**
 * MessagingAddress objects represent a 'place' that a message is sent to or from. All addresses
 * must be representable using less than 255 characters of plain-text ('address' is a varchar(255)
 * in the database). <br>
 * <br/>
 * Creating MessagingAddress objects should be done using a class that extends {@link Protocol}. Any
 * addresses created outside the Protocol factory methods are not guaranteed to be valid.
 * 
 * @see Protocol
 */
public class MessagingAddress extends BaseOpenmrsData {
	...
	/**
	 * Boolean that represents whether or not this is the preferred method of contact for a patient
	 */
	...
	/**
	 * Represents whether or not this message can be found in the OpenMRS address directory (i.e.
	 * other users can find this address and send messages to it)
	 */
