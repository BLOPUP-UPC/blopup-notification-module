...
/**
 * This is an interface for objects that wish to receive notifications about the status of messages
 * that have been sent. Registration to receive these notifications should be done by using one of
 * the sendMessage() methods that takes a delegate as a parameter.
 * 
...
public interface MessageDelegate {
	...
	/**
	 * This method will be called when a response is received for a message that was sent. Since
	 * determining which message is a response to which is sometimes a tricky process, this callback
	 * may not be 100% accurate or may not even be implemented by certain messaging frameworks
	 * 
