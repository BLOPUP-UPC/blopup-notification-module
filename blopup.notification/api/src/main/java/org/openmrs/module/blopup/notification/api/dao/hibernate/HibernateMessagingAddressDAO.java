...
import org.openmrs.module.blopup.notification.db.MessagingAddressDAO;
...
public class HibernateMessagingAddressDAO implements MessagingAddressDAO {
	...
	public MessagingAddress getMessagingAddress(Integer addressId) {
		return (MessagingAddress) sessionFactory.getCurrentSession().createCriteria(MessagingAddress.class)
		        .add(Restrictions.eq("messagingAddressId", addressId)).uniqueResult();
	}
