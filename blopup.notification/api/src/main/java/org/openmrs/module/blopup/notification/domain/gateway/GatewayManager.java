...
public class GatewayManager {
	...
	/**
	 * Returns all gateways that are active and support sending messages encoding in the supplied
	 * protocol
	 */
	...
	/**
	 * Returns all gateways that support sending messages encoding in the supplied protocol
	 */
