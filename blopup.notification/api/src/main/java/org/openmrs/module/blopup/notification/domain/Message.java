...
public class Message extends BaseOpenmrsObject {
	...
	/**
	 * The number of times that the system has tried to send the message. Once this number reaches
	 * the max_retries global property value, the message will be marked as 'failed' and the system
	 * will not continue to attempt to send it
	 */
	...
	/**
	 * Creates a message with a destination, origin, priority, and content. The date and origin are
	 * all filled in automatically at the time of sending.
	 * 
	...
	/**
	 * @return The sender's name if the sender is set. Otherwise it returns the address of origin
	 */
