package org.openmrs.module.blopup.notification.impl;
...
public class EncryptionServiceImpl implements EncryptionService {
	...
	private byte[] getSavedInitVector() throws IOException {
		...
		GlobalProperty gp = Context.getAdministrationService().getGlobalPropertyObject(
		    MessagingConstants.GP_ENCRYPTION_VECTOR);
	...
	private byte[] getSavedSecretKey() throws IOException {
		String keyText = Context.getAdministrationService().getGlobalProperty(MessagingConstants.GP_ENCRYPTION_KEY);
		...
		GlobalProperty gp = Context.getAdministrationService().getGlobalPropertyObject(MessagingConstants.GP_ENCRYPTION_KEY);
