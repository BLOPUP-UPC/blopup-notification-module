...
import org.openmrs.module.blopup.notification.impl.EncryptionServiceImpl;
...
public class EncryptionServiceTest extends BaseModuleContextSensitiveTest{
	...
	public void decrypt_shouldDecryptSmallAndLargeText() throws Exception {
		...
		EncryptionService encryptionService = new EncryptionServiceImpl(Base64.decode("9wyBUNglFCRVSUhMfsTa3Q=="),
